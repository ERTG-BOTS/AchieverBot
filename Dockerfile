...
WORKDIR /usr/src/app/achiever-bot

# Install uv
COPY --from=ghcr.io/astral-sh/uv:latest /uv /usr/local/bin/uv

# Copy project files first for better caching
COPY pyproject.toml uv.lock* /usr/src/app/achiever-bot/
...
COPY . /usr/src/app/achiever-bot

# Set the PATH to include the virtual environment
ENV PATH="/usr/src/app/achiever-bot/.venv/bin:$PATH"